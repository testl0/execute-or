...
execute unless data storage execute_or:temporary_data macro{conditions: []} if score target.execute_or.success objective.execute_or.success matches 0 run function execute_or:i/01 with storage execute_or:temporary_data macro
